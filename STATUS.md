...
## Current milestone
- v1.5 — core game shipped (UI footer label `v1.5`); post-V1 maintenance and polish in progress

## Last completed
- v1.5 version label set; start-screen tutorial; mobile/desktop GUI polish; rules-sync fix; win/defeat end handling
...
## Last verification (2026-05-31, v1.5)
...
- The core game is complete and shipped as v1.5; use this file for post-release progress or new blockers.
